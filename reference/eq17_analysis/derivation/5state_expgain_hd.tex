...
% ---- BUILD STATUS: COMPLETE.  Stages 1-6: motion error / gain model / true state
%      eq / output eq + H / estimator + error dynamics + F_e / Q,R.  y2 is the direct
%      (un-whitened) gain readout; F_e row 4 multiplier is Dhbar_d + (1-lc)dh3_hat;
%      hat usage: true values in the physical equations, estimates in H / F_e. ----
% ======================================================
