...
%          nothing is fitted.  p.7 keeps p.6's anchor AND prior: a controller
%          that does not know the boundary changed cannot be handed c_para's
%          own 9/16 coefficient.  Single seed (7); the 12-seed means differ from
...
\qquad
\text{anchor and prior unchanged}
