...
\[ e_{\delta x_1}[k] = \delta x_1[k] - \delta \hat x_1[k], \quad e_{a_x}[k] = a_x[k] - \hat a_x[k], \quad e_{\delta a_x}[k] = \delta a_x[k] - \delta \hat a_x[k] \]
\[ e_{y_1}[k] = y_1[k] - \hat y_1[k] = e_{\delta x_1}[k] + n_x[k], \qquad e_{y_2}[k] = y_2[k] - \hat y_2[k] = e_{a_x}[k] - d\cdot e_{\delta a_x}[k] + r_2[k] \]
\[
\begin{aligned}
