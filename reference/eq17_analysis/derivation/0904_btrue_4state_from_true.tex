...
%   Last two pages (09-07, replace the 09-04 three-arm figure): the b_true rung's final figure set, 10 seeds, Meng ramp
%     (left) and canon deep (right), four rows = a_hat/a_nom vs true, a_hat - a with the seed band, the b the law reads vs
%     b_true(w) at the true height, R dw3.
%     p.6 figures/ladder_btest_4row_abs_p0.png  -- the current recipe (prior P44[0] = envelope width);
%     p.7 figures/ladder_btp0_4row_abs_p0.png   -- the same arm with P44[0] matched to the seed-at-truth start
%     (SSOT S12 verdict: the fast-descent spread is that prior carried through the law's own sensitivity). No text.
% ======================================================
...
\clearpage
\thispagestyle{empty}
\noindent\includegraphics[width=\textwidth]{figures/ladder_btest_4row_abs_p0.png}

\clearpage
\thispagestyle{empty}
\noindent\includegraphics[width=\textwidth]{figures/ladder_btp0_4row_abs_p0.png}
