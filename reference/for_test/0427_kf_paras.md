...
**對應圖檔**: `reference/for_test/fig_qr_verification_h50/fig1_gain_estimation.png`、`fig2_tracking_error.png`
**Commit chain**:
...
完整推導 / 公式 / 各 Stage 解析參見 `reference/for_test/qr_verification_h50_final_2026-04-22.md`。
