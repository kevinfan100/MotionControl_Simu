...
**對應圖檔**: `reference/eq6_analysis/fig_qr_verification_h50/fig1_gain_estimation.png`、`fig2_tracking_error.png`
**Commit chain**:
...
完整推導 / 公式 / 各 Stage 解析參見 `reference/eq6_analysis/qr_verification_h50_final_2026-04-22.md`。
