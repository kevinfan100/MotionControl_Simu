...
**Documentation**:
- `reference/eq6_analysis/qr_verification_h50_final_2026-04-27.md` (this file)
- `reference/eq6_analysis/fig_qr_verification_h50/fig1_gain_estimation.png` — regenerated, run_simulation thesis style
- `reference/eq6_analysis/fig_qr_verification_h50/fig2_tracking_error.png` — regenerated; del_xmd LP overlay; equal subplot sizes; no ±1σ lines
