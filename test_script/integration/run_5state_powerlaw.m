function simOut = run_5state_powerlaw(config, opts)
%RUN_5STATE_POWERLAW  Standalone pure-MATLAB driver for the NEW 5-state
%   power-law-gain eq17 controller (motion_control_law_5state_powerlaw).
%
...
%
%   simOut = run_5state_powerlaw(config)
%   simOut = run_5state_powerlaw(config, opts)   % opts.seed, opts.verbose
%
...
%
%   See also: run_pure_simulation, motion_control_law_5state_powerlaw
    ...
    clear motion_control_law_5state_powerlaw trajectory_generator calc_thermal_force;
    ...
    for k = 1:N
        ...
        [f_d_k, ekf_k, diag_k] = motion_control_law_5state_powerlaw( ...
    ...
    simOut.meta = struct('config', config, 'params_value', P, ...
                         'seed', opts.seed, 'driver', 'run_5state_powerlaw');
