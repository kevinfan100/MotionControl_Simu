...
%   Generates:
%     - reference/qr_analysis/qr_positioning_h25_report.md
%     - reference/qr_analysis/qr_positioning_h50_report.md
%     - reference/qr_analysis/qr_positioning_summary.md
%     - reference/qr_analysis/fig_qr_positioning_summary.png
%     - test_results/verify/qr_positioning_combined.mat
    ...
    rep_dir = fullfile(project_root, 'reference', 'qr_analysis');
