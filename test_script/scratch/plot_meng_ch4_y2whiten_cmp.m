% FORK OF plot_meng_ch4_y2off_cmp.m @ 81e4047 | PURPOSE: ledger 29 figure -- e_a with claimed band, y2 raw vs whitened, 2 seeds | EXPIRES: with y2_whiten flag
...
exportgraphics(f,fullfile(od,'meng_y2whiten_band_cmp.png'),'Resolution',150);
fprintf('FIG DONE\n');
