...
%% Safety check
[is_safe_z, h_min_actual_z, t_crit_z] = check_trajectory_safety(p0_z, params_z);
[is_safe_xy, h_min_actual_xy, t_crit_xy] = check_trajectory_safety(p0_xy, params_xy);

% Convert to h_bar for display (backwards compatibility)
h_bar_min_z = h_min_actual_z / params_z.common.R;
h_bar_min_xy = h_min_actual_xy / params_xy.common.R;
